const Nav = ({ scroller }) => {
  return (
    <div className="shadow-lg z-10 flex px-12 sm:px-20 md:px-24 lg:px-52 fixed bottom-0 md:top-0 left-0 right-0 bg-gray-800 h-16 text-xs font-light text-secondary-200">
